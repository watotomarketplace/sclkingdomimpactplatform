...
/**
 * Addendum 3: Public signup is suspended for the 2026 cohort
 * (accounts are admin-pre-created). The page remains available for testing
 * and future cohorts. The Step 2 category selection has been removed —
 * Initiative Type is now captured at Milestone 1.
 */
